...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=Url::to(['adminlte2/plugins/iCheck/square/blue.css'])?>">
...
<!-- jQuery 3 -->
<script src="<?=Url::to(['adminlte2/bower_components/jquery/dist/jquery.min.js'])?>"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?=Url::to(['adminlte2/bower_components/bootstrap/dist/js/bootstrap.min.js'])?>"></script>
<!-- iCheck -->
<script src="<?=Url::to(['adminlte2/plugins/iCheck/icheck.min.js'])?>"></script>
<script>
  $(function () {
    $('input').iCheck({

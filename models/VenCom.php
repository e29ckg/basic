...
class VenCom extends \yii\db\ActiveRecord
{
    ...
    public function getVen_time(){   
        return [
            '08:30:00' => 'ฟื้นฟู/จับ-ค้น/ตรวจสอบการจับ(ผู้พิพากษา)',
            '08:30:01' => 'ฟื้นฟู/ตรวจสอบการจับ(ผอ/แทน)',
            '08:30:11' => 'ฟื้นฟู/ตรวจสอบการจับ(จนท.1)',
            '08:30:22' => 'ฟื้นฟู/ตรวจสอบการจับ(จนท.2)',
            '16:30:00' => 'จับ-ค้น-(ผู้พิพากษา)',
            '16:30:55' => 'จับ-ค้น(จนท.)',
        ];
    }
